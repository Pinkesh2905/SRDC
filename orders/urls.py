...
urlpatterns = [
    ...
    path('<int:order_id>/item/add/', views.order_item_add, name='order_item_add'),
    path('<int:order_id>/item/<int:item_id>/delete/', views.order_item_delete, name='order_item_delete'),
    path('<int:order_id>/payment/correct/', views.order_correct_payment, name='order_correct_payment'),
